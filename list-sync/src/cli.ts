...
function formatGuard(entry: { target: string; selector: string; desired?: string; actual?: string }): string {
...
function formatModule(entry: { target: string; selector: string }): string {
