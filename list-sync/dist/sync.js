...
function parseArgs() {
    const args = { tag: '', outDir: 'safe-batches', dryRun: false, help: false };
...
async function buildPlan(chain, tag, allowlist, provider) {
    const actions = [];
